...
. After login, run the *Project sync* for the *Demo project* to confirm job execution is working.

. In *Automation Execution* click on *Templates* and edit the *Demo Job Template*.

. Click on *Instance groups* and select *executionplane*, then save the job template.
