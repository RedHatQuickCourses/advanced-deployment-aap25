...
Assuming 6 events per task, 133 tasks/second will generate 133 * 6 = 798 events/second consuming 798 Kb per second for logs/event data. In other words, our Control node must be able to process around 789 events of data per second and it should have an execution capacity of 60 forks.
