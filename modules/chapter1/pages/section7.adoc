...
- Login to the `{bastion_public_hostname}` using the ssh command of the *Linux Developer Host* host from the RHDP login page and perform the following steps to know how to troubleshoot the AAP installation issues on OpenShift.
