...
- https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering%3D92347691[Product Enablement: AAP 2.7 Fundamentals and Deployment,windows=_blank].
