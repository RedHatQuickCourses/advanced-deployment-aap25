...
execute_init()
{
	...
	sed -i "s/advanced-deployment-aap25/${REPONAME}/g" *.* > /dev/null 2>&1
	sed -i "s/advanced-deployment-aap25/${REPONAME}/g" supplemental-ui/partials/header-content.hbs > /dev/null 2>&1
	echo -e "done"
